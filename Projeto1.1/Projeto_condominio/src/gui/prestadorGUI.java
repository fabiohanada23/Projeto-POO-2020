...
public class prestadorGUI extends javax.swing.JFrame {

    /**
     * Creates new form prestadorGUI
     */
    public prestadorGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("                 CADASTRO PRESTADOR");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        prestadores.setNome(jTextField1.getText());
        prestadores.setCpf(jTextField2.getText());
        prestadores.setAp_visita(jTextField3.getText());
        prestadores.setServico(jTextField4.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(prestadorGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new prestadorGUI().setVisible(true);
            }
        });
    }
