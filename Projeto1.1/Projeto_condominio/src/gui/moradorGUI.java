...
public class moradorGUI extends javax.swing.JFrame {

    /**
     * Creates new form moradorGUI
     */
    public moradorGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("                 CADASTRO MORADOR");
...
moradores.setNome(jTextField1.getText());
moradores.setCpf(jTextField2.getText());
moradores.setEmail(jTextField3.getText());
moradores.setTelefone(jTextField4.getText());
...
jTextField4.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(moradorGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
